...
import { MapPin, DollarSign, Clock, ArrowLeft, ArrowUpRight, Sparkles, Building2, CheckCircle2 } from "lucide-react";
      ...
      <div className="space-y-6 max-w-4xl mx-auto">
        ...
        <div className="bg-cream border border-border rounded-2xl p-6 md:p-8 shadow-sm">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-border">
            ...
            <div className="flex items-center gap-4 bg-sand/60 p-4 rounded-2xl border border-border/80">
              ...
              <div>
                ...
                <span className="text-xs text-warm-gray">High compatibility based on your resume</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-6 text-xs font-medium text-charcoal">
            ...
            <span className="flex items-center gap-1.5 bg-sand px-3 py-1.5 rounded-xl">
              <Clock size={14} className="text-terracotta" /> {job.type} • {job.experience}
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Right Column: Company Info & Sticky Apply CTA */}
          <div className="space-y-6">
            <div className="bg-cream border border-border rounded-2xl p-6 shadow-sm space-y-3">
              <h3 className="font-fraunces text-lg font-semibold text-charcoal flex items-center gap-2">
                <Building2 size={18} className="text-terracotta" /> About {job.company}
              </h3>
              <p className="text-xs text-warm-gray leading-relaxed">{job.about}</p>
            </div>
              ...
              {isApplied ? (
                <>
                  ...
                  <p className="text-xs text-warm-gray leading-relaxed">
                    You have already submitted your application for this role. You can view or update its status in your Applications tracker.
                  </p>
                  <Link
                    to="/applications"
                ...
                <>
                  ...
                  <p className="text-xs text-warm-gray">
                    Generate a tailored cover letter based on your uploaded resume and this job description.
                  </p>
                  <Link
